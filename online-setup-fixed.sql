-- Online Multiplayer Setup for Math Duel (FIXED VERSION)
...
-- Simple policies without UUID comparison (idempotent)
...
DROP POLICY IF EXISTS "Users can update invitations" ON game_invitations;
